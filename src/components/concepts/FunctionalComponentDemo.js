        ...
        <Container className="main">
            <Row>
                <Col xs="12">
                    ...
                    <p>Functional components are the primary tools used in React to build a small,
                    modular piece of your page.</p>
                    <dl>
                        <dt>Can use state</dt>
                        <dd>With the 'useState' hook, functional components can now both render a display to the page
                        and update the information to be shown.</dd>
    ...
    <div>
        <Card>
            ...
            <CardBody>
                ...
                <CardSubtitle>A JS Library</CardSubtitle>
                <CardText><pre> const HelloWorld = () ={'>'} </pre>.</CardText>  { /* had to put an expression bracket here */ }
